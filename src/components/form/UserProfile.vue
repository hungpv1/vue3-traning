                            ...
                            <div class="card-body">
                                <form @submit.prevent="updateSocial">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="text" class="form-control" v-model="instargram" />
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
...
export default {
    ...
    methods: {
        formSubmit() {
            ...
            request.put('user/current', data).then(res => {
                console.log(res)
        ...
        updateSocial() {
            const data = {
                ...
                email: this.github,
                phone: this.twitter,
                mobile: this.instargram,
                address: this.facebook
            }
            request.put('user/currentSocial', data).then(res => {
                console.log(res)
